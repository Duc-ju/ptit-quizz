...
const practices: Practice[] =
  [
    ...
    },
    {
      ...
      numberOfQuestion: 100,
      subjectCode: "kinh-te-chinh-tri-mac-lenin",
      description: "Đề tổng hợp từ  Trường Đại học Kinh doanh và Công nghệ Hà nội"
    },
    {
      ...
      chapters: [
        {
          ...
          description: "Chương 1 là khái niệm, đối tượng, phương pháp nghiên cứu và ý nghĩa học tập môn Tư tưởng Hồ Chí Minh."
        },
        {
          description: "Chương 2 gồm các ý chính như sau: Nguồn gốc hình thành tư tưởng Hồ Chí Minh, Quá trình hình thành và phát triển tư tưởng Hồ Chí Minh, Giá trị tư tưởng Hồ Chí Minh",
          idx: 1,
          numberOfQuestion: 50,
          title: "Tư tưởng Hồ Chí Minh chương 2"
        },
        {
          description: "Chương 3 gồm các ý chính như sau: Thực chất vấn đề dân tộc và cách mạng giải phóng dân tộc trong tư tưởng Hồ Chí Minh, Sự kế thừa và phát triển của Hồ Chí Minh về vấn đề dân tộc và cách mạng giải phóng dân tộc.",
          numberOfQuestion: 50,
          idx: 2,
        ...
        },
        {
          ...
          idx: 3,
          description: "Chương 4 gồm các ý chính như sau: Tư tưởng Hồ Chí Minh và con đường đi lên chủ nghĩa xã hội tại Việt Nam, Cơ sở lý luận và thực tiễn hình thành tư tưởng Hồ Chí Minh về chủ nghĩa xã hội và con đường đi lên chủ nghĩa xã hội tại Việt Nam"
        },
        {
          idx: 4,
          numberOfQuestion: 50,
          description: "Chương 5 gồm các ý chính sau:Tư tưởng Hồ Chí Minh về độc lập dân tộc, Tư tưởng Hồ Chí Minh về đoàn kết quốc tế, Vận dụng tư tưởng Hồ Chí Minh về độc lập dân tộc và đoàn kết quốc tế trong thời đại hiện nay",
    ...
    // mang-may-tinh
    {
      ...
      description: "Câu hỏi và giải thích được tham khảo trên github của bạn Huy Init",
      ...
      chapters: [
        {
          ...
          description: "Trong chương 1, chủ yếu là giới thiệu tổng quan về nội dung của Pháp luật đại cương. Người học sẽ được tìm hiểu nguồn gốc của nhà nước theo quan điểm Mác – Lênin và nguồn gốc pháp luật theo quan điểm Mác – Lênin.",
          idx: 0
        },
        {
          numberOfQuestion: 122,
          title: "Pháp luật đại cương chương 2",
          description: "Sau khi đã giới thiệu về nguồn gốc của nhà nước cũng như pháp luật ở phần 1, phần 2 sẽ nêu lên khái quát chung về nhà nước và pháp luật nước ta. Nguồn gốc ra đời, bản chất, vai trò và cách thức hoạt động là những nội dung mà người học sẽ được tìm hiểu trong phần này.",
          idx: 1
        },
        {
          numberOfQuestion: 48,
          ...
          description: "Phần 3 cung cấp nội dung về Bộ máy nhà nước Cộng hòa xã hội chủ nghĩa Việt Nam. Người học được dạy về những vấn đề chung cũng như các nguyên tắc tổ chức và hoạt động của bộ máy nhà nước Việt Nam. Đồng thời cũng giới thiệu tổng quát về bộ máy chính trị và nhà nước trong hệ thống chính trị."
        },
        {
          description: "Trong phần 4, bạn sẽ được học về hình thức pháp luật. Người học được tìm hiểu về khái niệm hình thức pháp luật và hệ thống văn bản quy phạm pháp luật ở Việt Nam.",
        ...
        },
        {
          ...
          idx: 4,
          description: "Nội dung chính của phần này là giới thiệu về vy phạm pháp luật và trách nhiệm pháp lý. Bên cạnh đó, người học còn được giới thiệu khái quát về pháp chế Xã Hội Chủ Nghĩa.",
          numberOfQuestion: 60
        },
        {
          numberOfQuestion: 2,
          description: "Phần 6 trình bày về vi phạm pháp luật và trách nhiệm pháp lý khi vi phạm pháp luật.",
          idx: 5,
          title: "Pháp luật đại cương chương 6"
        },
        {
          title: "Pháp luật đại cương chương 7",
          description: "Trong phần này, người học được tìm hiểu về các ngành luật cơ bản trong hệ thống pháp luật Việt Nam. Cụ thể:\nLuật Hiến pháp.\nLuật hành chính.\nLuật hình sự.\nLuật tố tụng hình sự.\nLuật dân sự.\nLuật hôn nhân và gia đình.\nLuật thương mại.\nLuật lao động.\nLuật đất đai.",
          numberOfQuestion: 37,
          idx: 6
        }
      ],
